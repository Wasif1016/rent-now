...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto focus-within:ring-0 focus-within:border-border", className)}>
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "cursor-pointer data-highlighted:bg-accent data-highlighted:text-accent-foreground relative flex w-full  items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
