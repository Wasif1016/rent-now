...
export function VehicleForm({ cities, vehicleModels, vehicleId, initialData }: VehicleFormProps) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const url = vehicleId ? `/api/vendor/vehicles/${vehicleId}` : '/api/vendor/vehicles'
      ...
      setErrors({ general: error.message || 'Failed to save vehicle. Please try again.' })
    } finally {
      setLoading(false)
    }
  }
  ...
  if (!user) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 mb-4">You must be logged in to add a vehicle.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Select
              ...
              onChange={(e) => {
                setFormData(prev => ({ ...prev, cityId: e.target.value, townId: '' }))
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, priceWithDriver: e.target.value }))}
              placeholder="5000"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, priceSelfDrive: e.target.value }))}
              placeholder="3000"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, priceWithinCity: e.target.value }))}
              placeholder="4000"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData(prev => ({ ...prev, priceOutOfCity: e.target.value }))}
              placeholder="6000"
            />
          </div>
        </div>
