...
export default function VendorLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-slate-50 mt-16">
      {/* Sidebar */}
      <aside className="hidden w-60 flex-col border-r bg-white/95 px-4 py-6 shadow-sm md:flex">
        <div className="mb-8 flex items-center gap-3 px-2">
          <div className="relative flex h-10 w-10 items-center justify-center rounded-full bg-primary text-sm font-semibold text-white overflow-hidden">
            {vendorLogo ? (
