...
export function CityKeywordModelLandingPage({
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      {/* Intro section – homepage-style gradient background (same as keyword-landing-page) */}
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="flex flex-col items-center justify-center text-center space-y-4">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-extrabold text-foreground tracking-tight text-center">
              Looking for {keywordNatural} {vehicleBrand} {vehicleModel} in {city}?
            </h2>
      ...
      {/* Why Choose + Vehicles – dark cards like WhyChooseUs (same as keyword-landing-page) */}
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-extrabold text-background mb-4">
              Why Choose Our {keywordNatural} {vehicleBrand} {vehicleModel} in {city}?
            </h2>
      ...
      {/* Use cases + How booking works – two columns (same as keyword-landing-page) */}
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="rounded-2xl border border-gray-800/50 bg-[#1a1a1a] p-8 space-y-5">
              ...
              <p className="text-normal text-gray-400">
                People choose {vehicleBrand} {vehicleModel} in {city} for many reasons:
              </p>
      ...
      {/* Trust + Find – two cards (same as keyword-landing-page) */}
      <section className="relative py-16 lg:py-24 bg-[#0a0a0a] overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(16,185,129,0.1),_transparent_70%)]" />
        </div>
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-gray-800/50 bg-[#1a1a1a] p-6 lg:p-8">
              <h3 className="text-xl font-bold text-white mb-3">Find {vehicleBrand} {vehicleModel} in {city}</h3>
              <p className="text-gray-400 text-normal">
                Searching for {vehicleModel} rent in {city}, {vehicleModel} with driver in {city}, or affordable {vehicleModel} rental in {city}? This page helps you find reliable vehicle rental options quickly and easily.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* FAQs – same layout as keyword-landing-page */}
      <section className="relative py-16 lg:py-24 bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              ...
              {vehicleBrand} {vehicleModel} in {city}?
            </h2>
            <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Compare available {vehicleModel} listings, connect with trusted rental companies in {city}, and book with confidence.
            </p>
            <Link href={`/search?model=${modelSlug}&city=${citySlug}`}>
              <Button
                size="lg"
                className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 font-semibold px-8 py-6 text-lg"
              >
                View Available {vehicleModel} in {city}
