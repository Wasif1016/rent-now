...
export function KeywordModelLandingPage({
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <IntroSection
        heading={`Looking for ${vehicleBrand} ${vehicleModel}?`}
        paragraphs={[
      ...
      <WhyChooseSection
        title={`Why Choose Our ${vehicleBrand} ${vehicleModel}?`}
      ...
      <UseCasesAndBookingSection
        useCases={{
          ...
          description: `People choose ${vehicleBrand} ${vehicleModel} for many reasons:`,
          items: USE_CASES,
        }}
        booking={{
      ...
      <TrustFindSection
        ...
        findCard={{
          title: `Find ${vehicleBrand} ${vehicleModel}`,
          description: `Searching for ${vehicleModel} rent, ${vehicleModel} with driver, or affordable ${vehicleModel} rental? This page helps you find reliable vehicle rental options quickly and easily.`,
        }}
      />
      ...
      {/* Final CTA */}
      <CTA vehicleBrand={vehicleBrand} vehicleModel={vehicleModel} modelSlug={modelSlug} />
    </main>
  )
}
