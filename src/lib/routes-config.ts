...
export const DEFAULT_TEMPLATES: Record<string, SeoTemplate> = {
  keyword_only: {
    ...
    description: 'Looking for {keyword_lower}? Compare verified rental vendors and book with a small advance.',
  },
  keyword_city: {
    h1: '{keyword} in {city}',
    title: '{keyword} in {city} | Best Car Rental Deals | RentNowPk',
    description: 'Compare verified car rental vendors in {city}. Browse vehicles for city and outstation trips. Pay only a small advance to confirm.',
  },
  keyword_model: {
    h1: '{brand} {model} {keyword}',
    title: '{brand} {model} for Rent | {keyword} | RentNowPk',
    description: 'Book {brand} {model} through {keyword_lower}. Compare verified rental options and book with ease.',
  },
  keyword_city_model: {
    h1: '{brand} {model} {keyword} in {city}',
    title: '{brand} {model} in {city} | {keyword} | RentNowPk',
    description: 'Find {brand} {model} in {city} for your next trip. Compare prices and book {keyword_lower} with trusted vendors.',
  },
  route: {
    h1: '{keyword} from {from_city} to {to_city}',
    title: '{keyword} from {from_city} to {to_city} | Intercity Route | RentNowPk',
    description: 'Book reliable vehicles with drivers for the {from_city} to {to_city} route. Compare vendors and book with a small advance.',
  },
}
  ...
  'airport-transfer': {
    ...
    templates: {
      city: {
        ...
        description: 'Book airport transfers in {city} with professional drivers. Ideal for late-night arrivals and family travel. Pay only a small advance.',
      }
    }
  },
