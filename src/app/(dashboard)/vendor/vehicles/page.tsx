...
function VendorVehiclesPageInner() {
  ...
  useEffect(() => {
    if (message) {
      ...
      router.replace(
        `/vendor/vehicles${params.toString() ? `?${params.toString()}` : ""}`
      );
    }
        ...
        <div className="mb-6 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Keep your vehicles up to date so customers always see what&apos;s
              available.
            </p>
          </div>
                      ...
                      <div className="flex flex-1 flex-col gap-3 p-4">
                        ...
                        <div className="mt-auto flex items-center gap-2 pt-2 border-t">
                          ...
                          <Button
                            ...
                            className="flex-1 text-[11px]"
                            onClick={() =>
                              window.open(`/listings/${vehicle.slug}`, "_blank")
                            }
                          >
